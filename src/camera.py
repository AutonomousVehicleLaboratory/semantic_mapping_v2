...
def camera_setup_1():
    ...
    Rt = np.array([[1.5426360183850896e-01, -6.8597082105982421e-02, 9.8564556584725482e-01, 4.7539938241243362e-02],
                  ...
                  [0., 0., 0., 1.]])
    # K = np.array([[1726.832663, 0.000000, 1045.027396],
    #               [0.000000, 1719.900336, 730.169234],
    #               [0.000000, 0.000000, 1.000000]])
    # Rt = np.array([
    #     [ 0.22777428915783074, 0.12486692661020114, 0.9656744398800082, 0.008607733136736476],
    #     [ -0.9734070971898622, 0.004303722812947854, 0.2290417016841166, 0.39671223212741796],
    #     [ 0.02444373823807403, -0.9921641641426443, 0.12252662997110698, -0.04160513712153129],
    #     [ 0.0, 0.0, 0.0, 1.0]
    #     ])
    R = Rt[0:3, 0:3].T
...
def camera_setup_6():
    ...
    Rt = np.array([[-2.1022535018250471e-01, -9.2112145235168197e-02, 9.7330398891652492e-01, -1.4076865278184414e-02],
                  ...
                  [0., 0., 0., 1.]])
    # K = np.array([[1724.002525, 0.000000, 993.370551],
    #               [0.000000, 1729.742694, 722.682579],
    #               [0., 0., 1.]])
    # Rt = np.array([
    #     [ -0.348192411648559, 0.16449742676518636, 0.9228773705417163, -0.01642279728548069],
    #     [ -0.9355490868907883, 0.001240951552891616, -0.35319451589323336, -0.3610594978252504],
    #     [ -0.05924483511811496, -0.9863767315923846, 0.15346332749211394, -0.03294809496668678],
    #     [ 0.0, 0.0, 0.0, 1.0]
    #     ]) 
