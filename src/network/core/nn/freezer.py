...
#             patterns (a sequence of str): strings which define all the patterns of interests
#                 The str should start with "module:" or ______(the parameter name?)
#         """
#         self.module = module
...
#         """
#         Freeze the parameters or modules define in patterns.
#         Args:
#             verbose: True if print out the modules and parameters that have been frozen.
#             logger: If logger is provided, verbose information will be printed on logger
#         """
...
def freeze_bn(module, eval, requires_grad, verbose=False, logger=None):
    """Freeze batch normalization in the module
    Args:
        module (nn.Module): the module to operate
        eval (bool): whether to using global stats
        requires_grad (bool): whether to freeze bn params
        verbose: True if print out the modules and parameters that have been frozen.
        logger: If logger is provided, verbose information will be printed on logger
    Notes:
    ...
    if verbose:
        frozen_modules = [name for name, m in module.named_modules() if not m.training]
